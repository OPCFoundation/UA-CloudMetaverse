...
namespace Microsoft.MixedReality.OpenXR
{
    ...
    [UnityEditor.XR.OpenXR.Features.OpenXRFeature(UiName = "HP Reverb G2 Controller Profile",
        ...
        Company = "Microsoft",
        Desc = "Allows for mapping input to the HP Reverb G2 controller.",
    ...
    internal class HPMixedRealityControllerProfile : OpenXRInteractionFeature
    {
        ...
        {
            /// <summary>
            /// A <see cref="Vector2Control"/> representing the <see cref="HPMixedRealityController.thumbstick"/> OpenXR binding.
            /// </summary>
            [Preserve, InputControl(aliases = new[] { "Primary2DAxis", "Joystick" })]
            public Vector2Control thumbstick { get; private set; }

            /// <summary>
            /// A <see cref="AxisControl"/> representing the <see cref="HPMixedRealityController.squeeze"/> OpenXR binding.
            /// </summary>
            [Preserve, InputControl(aliases = new[] { "GripAxis", "squeeze" })]
            public AxisControl grip { get; private set; }

            /// <summary>
            /// A <see cref="ButtonControl"/> representing the <see cref="HPMixedRealityController.squeeze"/> OpenXR binding.
            /// </summary>
            [Preserve, InputControl(aliases = new[] { "GripButton", "squeezeClicked" })]
            public ButtonControl gripPressed { get; private set; }

            /// <summary>
            /// A <see cref="ButtonControl"/> representing the <see cref="HPMixedRealityController.system"/> <see cref="HPMixedRealityController.menu"/> OpenXR bindings.
            /// </summary>
            [Preserve, InputControl(aliases = new[] { "menuButton" })]
            public ButtonControl menu { get; private set; }

            /// <summary>
            /// A <see cref="ButtonControl"/> representing the <see cref="HPMixedRealityController.buttonA"/> <see cref="HPMixedRealityController.buttonX"/> OpenXR bindings, depending on handedness.
            /// </summary>
            [Preserve, InputControl(aliases = new[] { "A", "X", "buttonA", "buttonX" })]
            public ButtonControl primaryButton { get; private set; }

            /// <summary>
            /// A <see cref="ButtonControl"/> representing the <see cref="HPMixedRealityController.buttonB"/> <see cref="HPMixedRealityController.buttonY"/> OpenXR bindings, depending on handedness.
            /// </summary>
            [Preserve, InputControl(aliases = new[] { "B", "Y", "buttonB", "buttonY" })]
            public ButtonControl secondaryButton { get; private set; }

            /// <summary>
            /// A <see cref="AxisControl"/> representing the <see cref="HPMixedRealityController.trigger"/> OpenXR binding.
            /// </summary>
            [Preserve, InputControl]
            public AxisControl trigger { get; private set; }

            /// <summary>
            /// A <see cref="ButtonControl"/> representing the <see cref="HPMixedRealityController.trigger"/> OpenXR binding.
            /// </summary>
            [Preserve, InputControl(aliases = new[] { "indexButton", "indexTouched", "triggerbutton" })]
            public ButtonControl triggerPressed { get; private set; }

            /// <summary>
            /// A <see cref="ButtonControl"/> representing the <see cref="HPMixedRealityController.thumbstickClick"/> OpenXR binding.
            /// </summary>
            [Preserve, InputControl(aliases = new[] { "joystickOrPadPressed" })]
            public ButtonControl thumbstickClicked { get; private set; }

            /// <summary>
            /// A <see cref="PoseControl"/> representing the <see cref="HPMixedRealityController.grip"/> OpenXR binding.
            /// </summary>
            [Preserve, InputControl(offset = 0, aliases = new[] { "device", "gripPose" })]
            public PoseControl devicePose { get; private set; }

            /// <summary>
            /// A <see cref="PoseControl"/> representing the <see cref="HPMixedRealityController.aim"/> OpenXR binding.
            /// </summary>
            ...
            /// <summary>
            /// A <see cref="Vector3Control"/> required for back compatibility with the XRSDK layouts. this is the device position. for the HP mixed reality controller, this is both the grip and the pointer position . this value is equivalent to mapping devicePose/position
            /// </summary>
            [Preserve, InputControl(offset = 32, aliases = new[] { "gripPosition" })]
            new public Vector3Control devicePosition { get; private set; }

            /// <summary>
            /// A <see cref="QuaternionControl"/> required for back compatibility with the XRSDK layouts. this is the device orientation. for the HP mixed reality controller, this is both the grip and the pointer rotation. this value is equivalent to mapping devicePose/rotation
            /// </summary>
        ...
        // Left Hand Only
        /// <summary>
        /// Constant for a <see cref="ActionType.Binary"/> interaction binding '.../input/x/click' OpenXR Input Binding. Used by <see cref="XrActionConfig"/> to bind actions to physical inputs. This binding is only available for the <see cref="UserPaths.leftHand"/> user path.
        /// </summary>
        public const string buttonX = "/input/x/click";
        /// <summary>
        /// Constant for a <see cref="ActionType.Binary"/> interaction binding '.../input/y/click' OpenXR Input Binding. Used by <see cref="XrActionConfig"/> to bind actions to physical inputs. This binding is only available for the <see cref="UserPaths.leftHand"/> user path.
        /// </summary>
        public const string buttonY = "/input/y/click";

        // Right Hand Only
        /// <summary>
        /// Constant for a <see cref="ActionType.Binary"/> interaction binding '.../input/a/click' OpenXR Input Binding. Used by <see cref="XrActionConfig"/> to bind actions to physical inputs. This binding is only available for the <see cref="UserPaths.rightHand"/> user path.
        /// </summary>
        public const string buttonA = "/input/a/click";
        /// <summary>
        /// Constant for a <see cref="ActionType.Binary"/> interaction binding '..."/input/b/click' OpenXR Input Binding. Used by <see cref="XrActionConfig"/> to bind actions to physical inputs. This binding is only available for the <see cref="UserPaths.rightHand"/> user path.
        /// </summary>
        public const string buttonB = "/input/b/click";

        // Both Hands
        /// <summary>
        /// Constant for a <see cref="ActionType.Binary"/> interaction binding '.../input/menu/click' OpenXR Input Binding. Used by <see cref="XrActionConfig"/> to bind actions to physical inputs. This binding is only available for the <see cref="UserPaths.leftHand"/> user path.
        /// </summary>
        public const string menu = "/input/menu/click";
        /// <summary>
        /// Constant for a <see cref="ActionType.Axis1D"/> interaction binding '.../input/squeeze/value' OpenXR Input Binding. Used by <see cref="XrActionConfig"/> to bind actions to physical inputs.
        /// </summary>
        ...
        /// <summary>
        /// Constant for a <see cref="ActionType.Axis2D"/> interaction binding '.../input/thumbstick' OpenXR Input Binding. Used by <see cref="XrActionConfig"/> to bind actions to physical inputs.
        /// </summary>
        public const string thumbstick = "/input/thumbstick";
        /// <summary>
        /// Constant for a <see cref="ActionType.Binary"/> interaction binding '.../input/thumbstick/click' OpenXR Input Binding. Used by <see cref="XrActionConfig"/> to bind actions to physical inputs.
        /// </summary>
