...
namespace Microsoft.MixedReality.OpenXR
{
    ...
    internal class PlaneSubsystem : XRPlaneSubsystem
    {
        ...
        private class OpenXRProvider : Provider
        {
            ...
            {
                NativeLib.SetSceneUnderstandingActive(nativeLibToken, true);
            }
            public override void Stop()
            {
                NativeLib.SetSceneUnderstandingActive(nativeLibToken, false);
            }
        ...
        // After 2020.2, the provider is created by Unity through the XRPlaneSubsystemDescriptorsubsystemTypeOverride
    ...
    internal class PlaneSubsystemController : SubsystemController
    {
        ...
        public override void OnSubsystemCreate(ISubsystemPlugin plugin)
        {
            ...
            NativeLib.CreateSceneUnderstandingProvider(nativeLibToken);
        }
